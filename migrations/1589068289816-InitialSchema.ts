...
export class InitialSchema1589068289816 implements MigrationInterface {
    name = 'InitialSchema1589068289816'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_105079775692df1f8799ed0fac" ON "follows" ("followerId", "followingId") `, undefined);
        await queryRunner.query(`CREATE TABLE "favorites" ("id" SERIAL NOT NULL, "articleId" integer, "userId" integer, CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_a399865198a065686cbb981db4" ON "favorites" ("articleId", "userId") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "tags" ("label" character varying NOT NULL, CONSTRAINT "PK_c3f918aeb3a1bba2e46f5945809" PRIMARY KEY ("label"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "articles_tag_list_tags" ("articlesId" integer NOT NULL, "tagsLabel" character varying NOT NULL, CONSTRAINT "PK_6f68e67134c96e7678b45251252" PRIMARY KEY ("articlesId", "tagsLabel"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_77fbcba9604a1725f5ac5f5aac" ON "articles_tag_list_tags" ("articlesId") `, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_986b099ae32d34809dd29db3d0" ON "articles_tag_list_tags" ("tagsLabel") `, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "favorites" ADD CONSTRAINT "FK_a9e25be94f65c6f11f420d97bca" FOREIGN KEY ("articleId") REFERENCES "articles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "favorites" ADD CONSTRAINT "FK_e747534006c6e3c2f09939da60f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "articles_tag_list_tags" ADD CONSTRAINT "FK_986b099ae32d34809dd29db3d00" FOREIGN KEY ("tagsLabel") REFERENCES "tags"("label") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "articles_tag_list_tags" DROP CONSTRAINT "FK_986b099ae32d34809dd29db3d00"`, undefined);
